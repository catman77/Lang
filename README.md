...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/catman77/Lang?quickstart=1)
...
### ☁️ Запуск в GitHub Codespaces (рекомендуется)

**Самый простой способ** — запустить проект в облаке без установки:

1. Нажмите кнопку **"Open in GitHub Codespaces"** выше (или `Code` → `Codespaces` → `Create codespace`)
2. Подождите ~30 секунд, пока создастся среда
3. Откройте любой ноутбук из `tutorials/` или `notebooks/`
4. Запустите все ячейки!

**Преимущества Codespaces:**
- ✅ Все зависимости установлены автоматически
- ✅ VS Code в браузере с полной поддержкой Jupyter
...
Пошаговое изучение системы:

| Ноутбук | Описание | Время |
|---------|----------|-------|
| [01_getting_started.ipynb](tutorials/01_getting_started.ipynb) | Основы системы переписывания | 15 мин |
| [02_mathematical_lifts.ipynb](tutorials/02_mathematical_lifts.ipynb) | Геометрия, меры, категории | 20 мин |
| [03_full_integration.ipynb](tutorials/03_full_integration.ipynb) | Полный пайплайн анализа | 25 мин |
| [04_advanced_examples.ipynb](tutorials/04_advanced_examples.ipynb) | Продвинутые примеры | 30 мин |

### Исследования (`notebooks/`)

| Ноутбук | Описание |
|---------|----------|
| [05_world_search.ipynb](notebooks/05_world_search.ipynb) | 🌌 **Главный**: Поиск физики из правил переписывания |

**05_world_search.ipynb** — центральный ноутбук проекта, демонстрирующий:
- Вывод закона гравитации $F \sim r^{-2}$ из power-law графа
- Три поколения частиц из иерархии масс
- Механизм Хиггса в терминах Space Language
- Квантовую механику из недетерминизма правил
...
# Или в Codespaces — просто откройте файл!
```
